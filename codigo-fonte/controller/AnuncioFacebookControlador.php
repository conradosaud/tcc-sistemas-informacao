...
include_once("../../model/AnuncioFacebook.php");
include_once("../../php/InterfaceREST.php");

class AnuncioFacebookControlador implements InterfaceREST{
    ...
    public function get($action, $obj) {
        switch($action){
            case "buscaPorIdEmpresa":
                $objFacebook = new AnuncioFacebook();
                $objFacebook = $objFacebook->buscaPorIdEmpresa($obj);
                return $objFacebook;
            case "busca":
                $objFacebook = new AnuncioFacebook();
                $objFacebook = $objFacebook->busca($obj);
                return $objFacebook;
            default:
                return false;
        }
    ...
    public function post($action, $obj) {
        switch($action){
            case "insere":
                $objFacebook = new AnuncioFacebook();
                $objFacebook = $objFacebook->insere($obj);
                return $objFacebook;
            default:
                return false;
        }
    ...
    public static function criaObj($IdFacebook, $IdEmpresa, $IdPagina, $NomePagina, $LinkPagina, $BoolCurtidas, $BoolComentarios, $BoolCompartilhar, $BoolEnviar){
        $obj = new AnuncioFacebook();
        $obj->setIdFacebook($IdFacebook);
        $obj->setIdEmpresa($IdEmpresa);
        $obj->setIdPagina($IdPagina);
        $obj->setNomePagina($NomePagina);
        $obj->setLinkPagina($LinkPagina);
        $obj->setBoolCurtidas($BoolCurtidas);
        $obj->setBoolComentarios($BoolComentarios);
        $obj->setBoolCompartilhar($BoolCompartilhar);
        $obj->setBoolEnviar($BoolEnviar);
