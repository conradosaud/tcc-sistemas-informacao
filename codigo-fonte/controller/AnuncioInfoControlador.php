...
include_once("../../model/AnuncioInfo.php");
include_once("../../php/InterfaceREST.php");

class AnuncioInfoControlador implements InterfaceREST{
    ...
    public function put($action, $objAtual, $objNovo) {
        $objAnuncio = new AnuncioInfo();
        $objAnuncio = $objAnuncio->altera($objAtual, $objNovo);
        return $objAnuncio;
    }
    ...
    public static function criaObj($EntregaDomicilio, $AtendeLocal, $Estacionamento){
        $obj = new AnuncioInfo();
        $obj->setAtendeLocal($AtendeLocal);
        $obj->setEntregaDomicilio($EntregaDomicilio);
        $obj->setEstacionamento($Estacionamento);
